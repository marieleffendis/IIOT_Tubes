...
=======
        ...
        # start_conveyor()
        print("[AKSI] Conveyor on")
>>>>>>> 07de619408a930b87e30b452deb6e668473d7ea9

def arm_works(cx, cy, color):
    # Fungsi ini akan dipanggil setelah conveyor mati
    print(f"[AKSI] Robotic arm bergerak ke ({cx}, {cy}) untuk mengambil objek {color}")
    time.sleep(10) # Simulasi waktu kerja lengan robot
    print(f"[AKSI] Selesai mengambil {color}.")
            ...
            if contours:
                ...
                if cv2.contourArea(c) > 500:
                    ...
                    if M["m00"] != 0:
                        ...
                        arm_works(cX_global, cY_global, color_name)
